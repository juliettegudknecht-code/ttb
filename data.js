...
/* Active federal basic permits by state, aggregated from the TTB FOIA List of
   Permittees (July 6, 2026 publication). Each state is [importers, wholesalers,
...
const PERMITTEES = {
  sourceName: "TTB FOIA List of Permittees, July 6, 2026 publication",
  ...
  states: {
    ...
    AR: [42, 269, 23, 46],
    AZ: [309, 391, 71, 169],
    CA: [4664, 9316, 569, 6391],
    CO: [457, 793, 175, 274],
    CT: [353, 430, 43, 113],
    DC: [168, 163, 14, 11],
    DE: [150, 176, 7, 16],
    FL: [2795, 2680, 198, 212],
    GA: [461, 685, 147, 205],
    HI: [108, 134, 29, 23],
    IA: [71, 927, 55, 182],
    ID: [69, 173, 35, 125],
    ...
    SD: [13, 38, 19, 47],
    TN: [171, 410, 143, 128],
    TX: [1654, 2129, 326, 1010],
    UT: [54, 88, 33, 39],
    VA: [502, 713, 156, 639],
    VT: [55, 135, 54, 104],
    WA: [559, 1905, 239, 1424],
    WI: [177, 436, 123, 252],
    WV: [26, 188, 38, 47],
    WY: [46, 91, 21, 20]
  }
